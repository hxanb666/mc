...
check_server() {
set_color
echo "脚本由${magenta}我爱摆烂${none}提供 B站:不会PHP的屑 QQ:1243155454"
echo "本脚本只支持amd64架构的Ubuntu,其他系统可自行尝试"
echo "感谢热心网友提供测试支持!"
if [ -e ${HOME}/mc ]
then
...
green='\e[92m'
none='\e[0m'
echo "${green}公益内网穿透${none}"
echo "${green}http://ksweb.club:9090${none}"
case "$1" in
s | start)
cd ${HOME}/mc
...
;;
c | configure)
chmod +x mc.sh && sh mc.sh
;;
h* | H*)
echo "你可以输入${green}mc${none}打开菜单"
echo "你可以输入${green}mc s${none}或${green}mc start${none}来启动mc基岩版服务器"
echo "你可以输入${green}mc c${none}或${green}mc configure${none}来配置mc基岩版服务器"
;;
*)
